...
import tinytorch
from tinytorch import Parameter, Scalar
...
class Network2(tinytorch.Module):
    def __init__(self) -> None:
        super().__init__()
...
class ScalarLinear(tinytorch.Module):
...
#     tinytorch.derivative_check(check, *(inputs + bias))
