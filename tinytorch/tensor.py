...
class Tensor:
    ...
    history: Optional[History]  # means Union[History, None]
    ...
    def __len__(self):
        return len(self._tensor._storage)
    
    def __getitem__(self, key: Union[int, UserIndex]) -> float:
        # print("len ->", len(self)) 一维矩阵会越界？
        # if isinstance(key, int) and (key < 0 or key >= len(self)):
    ...
    def make(
        ...
        # print("stride ->", strides) 这里的 stride = None，会在TensorData计算默认行优先的stride
        # print("this backend", backend) 
